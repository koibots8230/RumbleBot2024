...
public class IntakeCommands {
    ...
    public static Command reverse(Intake intake, Indexer indexer) {
        return Commands.parallel(
                indexer.reverseIndexerCommand(Constants.IndexerConstants.TOP_REVERSE_SPEED, Constants.IndexerConstants.BOTTOM_REVERSE_SPEED),
    ...
    public static Command stop(Intake intake, Indexer indexer) {
        return Commands.parallel(
                indexer.reverseIndexerCommand(Constants.IndexerConstants.TOP_MOTOR_STOP, Constants.IndexerConstants.BOTTOM_MOTOR_STOP),
